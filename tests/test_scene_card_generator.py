    ...
    return [
        {
            ...
            "opening_hook": "The comm crackled with static",
            "closing_hook": "Ben stared at the coordinates — deep Outer Rim",
            "emotional_trajectory": "Doubt to acceptance",
            "characters_present": ["Ben", "Kira"],
            "stakes": {"personal": "Ben's sense of purpose", "interpersonal": "", "external": "The mission"},
        ...
        },
        {
            ...
            "opening_hook": "The ship dropped out of hyperspace into silence",
            "closing_hook": "The readings spiked — something was alive down there",
            "emotional_trajectory": "Calm to fear",
            "characters_present": ["Ben", "Kira"],
            "stakes": {"personal": "Survival", "interpersonal": "", "external": "The wound is expanding"},
...
class TestSceneCardGenerator:
    ...
    async def test_generate_with_physics_retry(self, mock_router, seed):
        ...
        sem_ok_card = {
            ...
            "opening_hook": "Hook open", "closing_hook": "Hook close",
