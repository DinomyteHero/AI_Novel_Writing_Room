...
**Status:** historical proposal; superseded for current production by lean mode plus manuscript-level review/cleanup.
...
- Historical recommendation at proposal time: Sonnet 4.6 remained the default drafter until change 6 landed. Current production uses DeepSeek V4 Pro in lean mode.
