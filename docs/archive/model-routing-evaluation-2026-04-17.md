...
>
> **Current production update (2026-04-26):** Live routing has moved to lean mode: DeepSeek V4 Pro drafter, GPT-5.4 Mini line edit, GPT-5.4 full-manuscript review, and targeted cleanup as the default final polish branch.
...
| `manuscript_reviewer` | `moonshotai/kimi-k2` | Historical full-manuscript feedback route; current production uses GPT-5.4 |
...
- Historical recommendation: keep `manuscript_reviewer` on `kimi-k2`. Current production uses GPT-5.4 for full-manuscript review.
